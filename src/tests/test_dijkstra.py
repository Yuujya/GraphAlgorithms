...
class TestBellmanFord(unittest.TestCase):
    def test_dijsktra(self):
        edges = {Edge(5, 1, 5), Edge(2, 3, 3),
                 Edge(2, 6, 4), Edge(6, 7, 1), Edge(7, 4, 2)}
        ...
        _, _, shortest_path = dijkstra(undirected_graph,
                                       start_vertex,
                                       target_vertex)
    ...
    def test_dijsktra_predecessors(self):
        ...
        expected_predecessors = {3: 2, 4: 7, 1: None,
                                 5: None, 6: 2, 7: 6, 2: 0}
        predecessors, _, _ = dijkstra(undirected_graph,
                                      start_vertex)
    ...
    def test_dijsktra_distances(self):
        ...
        _, distances, _ = dijkstra(undirected_graph,
                                   start_vertex)
